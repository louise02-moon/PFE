...
def build_all_pairs(arc, fn, res50, zz, idxa, idxb):
    ...
    X_deep = zscore_normalize(np.concatenate([arc_p, fn_p, res_p], axis=1))
...
def main():
    ...
    for rel in RELATIONS:
        ...
        X, deep_dim, zz_dim = build_all_pairs(
            arc_feats, fn_feats, res_feats, zz_feats, idxa, idxb
        )
