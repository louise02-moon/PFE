...
if __name__ == "__main__":
    ...
    output_dir   = r"C:\Users\surface laptop 5\OneDrive\Documents\PFE\Apprentissage_profond\VGG19\vgg19_embeddings"
    ...
    for relation in RELATIONS:
        ...
        output_file = os.path.join(output_dir, f"VGG19_{relation}.pkl")
        with open(output_file, "wb") as f:
            pickle.dump(embeddings, f)

        print(f"  Saved: VGG19_{relation}.pkl  ({len(embeddings)} images)")
