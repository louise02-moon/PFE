...
model = ResNet101(weights='imagenet', include_top=False, pooling='max')
...
if __name__ == "__main__":
    ...
    output_dir   = r"C:\Users\surface laptop 5\OneDrive\Documents\PFE\Apprentissage_profond\ResNet101\resnet101_embeddings"
    ...
    for relation in RELATIONS:
        ...
        output_file = os.path.join(output_dir, f"ResNet101_{relation}.pkl")
        with open(output_file, "wb") as f:
            pickle.dump(embeddings, f)

        print(f"  Saved: ResNet101_{relation}.pkl  ({len(embeddings)} images)")
