...
#  Channels : H, S, V + L, a, b  (6 channels)
#  Output   : /home/nadjia/HistZigZag/hsv_lab/
# ============================================================
...
OUT_DIR      = "/home/nadjia/HistZigZag/hsv_lab"
...
print(f"Extracting: HSV+LAB | patch={PATCH_SIZE} step={STEP_SIZE}")
