...
RELATIONS = {
    "Father-Daughter": {
        "pkl": f"{PKL_DIR}\\ResNet50_FD.pkl",
        "mat": f"{MAT_DIR}\\LBP_fd.mat",
    },
    "Father-Son": {
        "pkl": f"{PKL_DIR}\\ResNet50_FS.pkl",
        "mat": f"{MAT_DIR}\\LBP_fs.mat",
    },
    "Mother-Daughter": {
        "pkl": f"{PKL_DIR}\\ResNet50_MD.pkl",
        "mat": f"{MAT_DIR}\\LBP_md.mat",
    },
    "Mother-Son": {
        "pkl": f"{PKL_DIR}\\ResNet50_MS.pkl",
...
print(f"\n{'='*50}")
print("  ACCURACY GLOBALE — RESNET50 (ECHELLE DECIMALE)")
print(f"{'='*50}")
