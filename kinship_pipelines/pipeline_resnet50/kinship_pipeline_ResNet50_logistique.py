...
PKL_DIR = r"C:\Users\surface laptop 5\OneDrive\Documents\PFE\Apprentissage profond\ResNet50\resnet50_embeddings"
MAT_DIR = r"C:\Users\surface laptop 5\OneDrive\Documents\PFE\lbp"

RELATIONS = {
    "Father-Daughter": {"pkl": f"{PKL_DIR}\\ResNet50_FD.pkl", "mat": f"{MAT_DIR}\\LBP_fd.mat"},
    "Father-Son": {"pkl": f"{PKL_DIR}\\ResNet50_FS.pkl", "mat": f"{MAT_DIR}\\LBP_fs.mat"},
    "Mother-Daughter": {"pkl": f"{PKL_DIR}\\ResNet50_MD.pkl", "mat": f"{MAT_DIR}\\LBP_md.mat"},
    "Mother-Son": {"pkl": f"{PKL_DIR}\\ResNet50_MS.pkl", "mat": f"{MAT_DIR}\\LBP_ms.mat"},
}
...
for relation, paths in RELATIONS.items():
    ...
    all_results[relation] = {"fold_scores": fold_scores, "mean_accuracy": mean_acc}
...
print(f"\n{'='*50}")
print("  ACCURACY GLOBALE — RESNET50 (LOGISTIQUE)")
print(f"{'='*50}")
print(f"  ResNet50 Accuracy : {overall_acc * 100:.2f}%")