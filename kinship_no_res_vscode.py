...
ZZ_DIR       = "/home/nadjia/HistZigZag/ps16_ss8"
...
def build_all_pairs(arc, fn, vggface, zz, idxa, idxb):
    ...
    X_deep = zscore_normalize(np.concatenate([arc_p, fn_p, vgg_p], axis=1))
...
def main():
    ...
    for rel in RELATIONS:
        ...
        X, deep_dim, zz_dim = build_all_pairs(
            arc_feats, fn_feats, vgg_feats, zz_feats, idxa, idxb
        )
